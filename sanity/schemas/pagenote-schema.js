const pageNote = {
    ...
    fields: [
      ...
      },
      {
        ...
        title: 'Information Page - Department 1',
        type: 'string',
        description: 'Department for the sidebar and mobile footer of the Information page',
      },
      {
        name: 'aboutEmailD1',
        title: 'Information Page - Email for Department 1',
        type: 'string',
        description: 'Email address associated with Department 1 on the Information page',
      },
      {
        name: 'aboutDepartment2',
        title: 'Information Page - Department 2',
        type: 'string',
        description: 'Department for the second section in the sidebar and mobile footer of the Information page',
      },
      {
        name: 'aboutEmailD2',
        title: 'Information Page - Email for Department 2',
        type: 'string',
        description: 'Email address associated with Department 2 on the Information page',
      },
      {
        name: 'aboutDepartment3',
        title: 'Information Page - Department 3',
        type: 'string',
        description: 'Department for the third section in the sidebar and mobile footer of the Information page',
      },
      {
        name: 'aboutEmailD3',
        title: 'Information Page - Email for Department 3',
        type: 'string',
        description: 'Email address associated with Department 3 on the Information page',
      },
      {
